...
public class WordsFilter {
    ...
    public static void initBadWords(final InputStream inputStream) {
    ...
    public static void loadConfigs() {
        try {
            ...
            Log.d("TAG", "loadConfigs: Loaded " + counter + " words to filter out");
    ...
    public static ArrayList<String> badWordsFound(String input) {
        ...
        for (String s : badWords) {
            Log.d(TAG, String.format("badWordsFound: %s qualified as a bad word in a username", s));
        }
        return badWords;
    }
